...
enum Detector { barcode, face, label, cloudLabel, text, cloudText, cloudDocumentText }
...
class DocumentTextDetectorPainter extends CustomPainter {
  ...
  bool shouldRepaint(DocumentTextDetectorPainter oldDelegate) {
    return oldDelegate.absoluteImageSize != absoluteImageSize || oldDelegate.visionDocumentText != visionDocumentText;
  }
}
