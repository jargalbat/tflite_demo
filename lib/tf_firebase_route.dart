...
class _TfFirebaseRouteState extends State<TfFirebaseRoute> {
  ...
  static Future<File> loadModelFromFirebase() async {
    try {
      ...
      final model = FirebaseCustomRemoteModel('mobilenet2');
  ...
  static Future<String> loadTFLiteModel(File modelFile) async {
    try {
      ...
      final labelsData = await rootBundle.load("assets/labels_mobilenet_v1_224.txt");
      final labelsFile = await File(appDirectory.path + "/_labels_mobilenet_v1_224.txt")
