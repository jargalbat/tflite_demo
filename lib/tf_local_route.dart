...
class TfLocalRoute extends StatefulWidget {
  @override
  _TfLocalRouteState createState() => new _TfLocalRouteState();
}

class _TfLocalRouteState extends State<TfLocalRoute> {
  File _image;
  List _recognitions;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('TensorFlow demo'),
        actions: <Widget>[
